...
<html lang="en">
    ...
    <div class = "center-justified">
			...
			<div class="data-http">
					<div id="HTTP" class="data-hhtp3">
						...
						<ul>
                            ...
                            <br>
								<ul>
									<ul> •CSS1 (December 1996)</ul>
									<ul> •CSS2 (May 1998)</ul>
									<ul> •CSS3 (June 1999)</ul>
									<ul> •CSS4 (March 2017)</ul>
								</ul>
							</ul>
					   </div>
                    </div>
        ...
        <div>
            <center>
            <a href="CSS.php" class="previous">&laquo; Previous</a>
			<a href="CSS3.php" class="next">Next &raquo;</a>
                </center>
            </div>
