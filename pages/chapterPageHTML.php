    ...
    <body>  
       <div class="navbar">
		...
		<div class = "center-justified">
            ...
            <div>
            <center>
                 <a href="html4.php" class="previous">&laquo; Previous</a>
                 <a href="http.php" class="next">&laquo; HTTP </a>
                <a href="CSS.php" class="next"> CSS &raquo;</a>
                 <a href="quiz.php" class="next">Take the Quiz! &raquo;</a>
                </center>
            </div>
		</div>
